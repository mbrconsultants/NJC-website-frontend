            ...
            <div className="rv-service-details__left">
              ...
              <DivAnimateYAxis>
                ...
                <p className="rv-service-details__descr">
                  ...
                  section 153(1) of the 1999 Constitution with powers relating
                  to appointments and exercise of disciplinary control over
                  Judicial Officers specified in paragraph 21 of Part I of the
                  Third Schedule of the Constitution. By the same paragraph it
                  also has power to collect, control and disburse all monies,
                  capital and recurrent, for the judiciary and to deal with all
                  matters relating to policy and administration.
                </p>
                <h5>RULE TWO</h5>
                <p className="rv-service-details__descr">
                  1. Whenever the Chairman of a State Judicial Service
                  Commission proposes to embark on the process for appointment
                  of candidates or a candidate to Judicial Office in the State,
                  notice shall be given to the Governor of the State concerned
