            ...
            <div className="rv-service-details__left">
              ...
              <DivAnimateYAxis>
                ...
                <p className="rv-service-details__descr">
                  The Federal Judicial Service Commission, State Judicial
                  Service Commission and the Judicial Service Committee of the
                  Federal Capital Territory shall comply with these Rules in
                  their advice to National Judicial Council for nominations or
                  recommendations of candidates for appointment of Judicial
