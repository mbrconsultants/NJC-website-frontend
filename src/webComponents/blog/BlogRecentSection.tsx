...
interface Props {
  allNews: Blog[];
  AllBlogSection?: React.ComponentType;
}

const BlogRecentSection: React.FC<Props> = ({ allNews, AllBlogSection }) => {
  ...
  return (
    <DivAnimateYAxis className="rv-blog-details-right rv-blog-details-recents">
      ...
      {allNews && allNews.slice(0, 3).map((item) => (
